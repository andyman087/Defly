...
*/
   document.addEventListener("DOMContentLoaded", () => {
    ...
    // Debug check if overlay is correctly appended
    ...
    function updateOverlay(currentSessionStats, lastDayStats) {
        console.log("Updating overlay with stats:", currentSessionStats, lastDayStats);
    ...
    function fetchAllStats(callback) {
        console.log("Fetching all stats from:", stats_endpoint);
    ...
    function filterCurrentSessionStats(user_data) {
        ...
        const selectedRecords = user_data.slice(0, totalDeaths);
        return selectedRecords.reverse();
    }
    ...
    function aggregateCurrentSessionStats(user_data) {
        ...
        totals.totalRoundsPlayed = parseInt(roundsWonText.split('/')[1]);
    ...
    console.log("Started interval for checking and updating stats");
});
